...
const Locations: NextPage<LocationsProps> = async ({ params: { lang } }) => {
  ...
  const uaeLocation = {
    ...
    locationDetails: "Hapag-Lloyd building - Road - القرهود - دبي - الإمارات العربية المتحدة",
  ...
  return (
      ...
      <main className="flex bg-white flex-col items-center justify-center min-h-screen py-2 ">
